            ...
            <div class="grid grid-cols-2 gap-6">
                ...
                <div class="bg-white rounded-xl shadow-lg p-6 h-36 relative border border-gray-900">
                    ...
                    <div class="h-20 flex items-center justify-start relative">
                        ...
                        <div class="text-xs ml-4 space-y-1">
                            <div class="flex items-center"><span class="w-2 h-2 rounded-full bg-blue-500 mr-2"></span>Placas de vídeo</div>
                            <div class="flex items-center"><span class="w-2 h-2 rounded-full bg-red-500 mr-2"></span>Processadores</div>
                            <div class="flex items-center"><span class="w-2 h-2 rounded-full bg-yellow-500 mr-2"></span>Placas mãe</div>
                        </div>
                         <div class="absolute top-1/2 left-[18%] transform -translate-x-1/2 -translate-y-1/2 font-bold text-2xl text-gray-800">{{ $metricas['saidas_mes'] }}</div>
                    </div>
                </div>

                <div class="bg-white rounded-xl shadow-lg p-6 h-36 flex flex-col justify-center border border-gray-900">
                ...
                <div class="bg-white rounded-xl shadow-lg p-6 h-36 border border-gray-900">
                    ...
                    <div class="h-20 flex flex-col justify-center items-start text-sm">
                        ...
                        <p class="text-gray-600">Total de itens: <span class="font-bold text-gray-800">{{ $metricas['total_itens'] }}</span></p>
                        <p class="text-gray-600">Total de categorias: <span class="font-bold text-gray-800">{{ $metricas['total_categorias'] }}</span></p>
                        <p class="text-gray-600">Valor do estoque: <span class="font-bold text-green-600">{{ $metricas['valor_estoque'] }}</span></p>
                    </div>
                </div>
            </div>
        </div>
