            ...
            @php
                $menu = [
                    'Relatórios' => [
                        ...
                        'sub' => ['Visão geral' => route('dashboard'), 'Itens em estoque' => '#', 'Usuários' => '#']
                    ],
                    'Estoque' => [
                        ...
                        'sub' => ['Listar' => route('stock.list'), 'Adicionar novo' => route('stock.show_create_item_form'), 'Movimentações' => '#']
                    ],
                    'Funcionários' => [
                ...
                <div class="nav-item">
                    ...
                    <div class="submenu @if($title === 'Relatórios') expanded @endif ml-2"
                        ...
                        <ul class="pt-1 space-y-1 text-base text-gray-700">
                            @foreach($item['sub'] as $label => $link)
