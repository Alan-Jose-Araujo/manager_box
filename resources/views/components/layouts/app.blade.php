...
<head>
    ...
    <style>
        ...
        .sidebar:hover, .sidebar.sidebar-fixed {
            width: 14rem;
        ...
        .sidebar.sidebar-fixed .sidebar-text, .sidebar.sidebar-fixed .submenu-item {
    ...
    <header class="h-16 flex items-center justify-between border-b border-gray-100/50 shadow-sm px-6 sticky top-0 z-10" style="background-color: #F8F2EC;">
        ...
        <div class="flex items-center space-x-4">
            ...
            <div id="profileMenu" class="profile-menu relative cursor-pointer">
                <div class="w-10 h-10 rounded-full overflow-hidden shrink-0 border-2 border-transparent hover:border-gray-500 transition-colors duration-200">
                    <img src="{{ asset('images/ana_carolina_avatar.png') }}" alt="Ana Carolina" class="w-full h-full object-cover">
                </div>

                <div id="profileDropdown" class="profile-dropdown absolute right-0 mt-3 w-72 bg-white rounded-xl shadow-2xl border border-gray-100 z-50 transform origin-top-right">
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <div class="flex items-center space-x-2">
                                    ...
                                    <span class="text-xs font-medium bg-green-500 text-white px-2 py-0.5 rounded-full">Admin</span>
                                </div>
                    ...
                    <div class="py-2 border-b border-gray-200">
                        ...
                        <a href="#" class="flex justify-between items-center px-4 py-2 text-gray-700 hover:bg-stone-100">
                            Assinatura
                        ...
                        <a href="#" class="block px-4 py-2 text-gray-700 hover:bg-stone-100">Ajustes de interface</a>
                    </div>
                    ...
                    <div class="py-2">
                        ...
                        <div class="flex justify-between items-center px-4 py-2 text-gray-700">
                            Idioma
                            <span class="text-sm font-medium bg-stone-100 text-gray-700 px-2 py-1 rounded-full flex items-center space-x-2">
                                Português <img src="https://flagcdn.com/16x12/br.png" width="16" height="12" alt="Bandeira do Brasil">
                            </span>
                        </div>

                        <a href="#" class="block px-4 py-2 text-gray-700 hover:bg-stone-100">Configurações da conta</a>
            ...
            <div class="p-2 text-gray-500 hover:text-gray-700 cursor-pointer rounded-lg hover:bg-stone-200 hidden md:block">
                <svg class="w-6 h-6 navbar-icon" width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
